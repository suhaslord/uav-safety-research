...
def test_phase6b_episode_is_deterministic():
    ...
    a = run_phase6b_episode(123456, "occlusion", temporal, component)
    b = run_phase6b_episode(123456, "occlusion", temporal, component)

    assert a.to_dict() == b.to_dict()
    assert a.architecture == "image_aegis_phase6b"


def test_phase6b_component_metrics_are_bounded():
    ...
    result = run_phase6b_episode(654321, "mixed", temporal, component)
