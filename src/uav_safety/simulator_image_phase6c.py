...
def run_phase6c_episode(
    ...
    *,
    ...
    """Run Phase 6C with position-only altitude reference takeover.

    All environment, image, temporal tracking, robust velocity filtering,
    independent reference estimation, controller, and frozen V3 supervisor logic
    match Phase 6B. The only architectural change is in the Phase 6C fusion
    adapter: altitude abstention may blend z but preserves the established
    Phase 6 control vz.
    """
    ...
    result = Phase6BEpisodeResult(
        seed=seed,
        condition=condition,
        architecture="image_aegis_phase6c",
        outcome=outcome,
