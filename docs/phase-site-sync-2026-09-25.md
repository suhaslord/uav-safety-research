...
| The visual sweep treated a full-height research photo as empty section space, and counted clipped skip links and checkbox squares instead of their wrapping tap areas. | Measured the photo as a page block, excluded the keyboard-only hidden skip link from touch sizing, and sized the checkbox label to 44px. |
