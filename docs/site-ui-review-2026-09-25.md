...
| Shared phase navigation, experiment links, and NASA caption sources had short tap areas on phones; five synthetic image labels used 10px type. | Home, experiment, phases, Phase 24 | Raised the tap area to at least 44px for the affected shared controls and visible links; enlarged the labels to 12px. |
