...
const deployAssets = new Set([
  ...
  'phase-polish-fixes.css', 'phase-polish-v2.css', 'phase-ui-consistency.css', 'liquid-glass.css',
  'final-convergence.css', 'final-convergence-base.css', 'craft-polish.css', 'frozen-lineage.js',
